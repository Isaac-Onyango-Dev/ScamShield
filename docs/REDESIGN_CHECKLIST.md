...
- [ ] **LOGO-10** Brand assets are lighter than the old 318 KB JPEG. Verify: `du -cb client/public/*.svg client/public/*.png | tail -1` → < 150000 (the vendored fonts in `client/public/fonts` are measured by FONT-01/02 instead; decision D6 moved ~98 KB of fonts there after this item was written)
